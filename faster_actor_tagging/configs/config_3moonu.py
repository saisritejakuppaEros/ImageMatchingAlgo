"""
Configuration File for Actor Face Detection Pipeline - 3 Moonu (2012)
=====================================================
...
MOVIE_FRAMES_DIR = '/data0/PArun/Quality_checklist/dataset/cropped_detected_shots/Oct_13/3Moonu'  # UPDATE THIS PATH

# Output: Base directory for all outputs
OUTPUT_DIR = 'output_data/3Moonu'
