"""
Configuration File for Actor Face Detection Pipeline - Hey Ram (2000)
=====================================================

Edit the variables below for your movie and actors.
All paths can be absolute or relative.
NOTE: Only Shah Rukh Khan embedding available (Kamal Haasan embedding not available)
"""

# ========== INPUT/OUTPUT PATHS ==========

# Input: Directory containing movie frames (will be searched recursively)
MOVIE_FRAMES_DIR = '/data0/PArun/Quality_checklist/dataset/cropped_detected_shots/Sep/HEY RAM'  # UPDATE THIS PATH

# Output: Base directory for all outputs
OUTPUT_DIR = 'output_data/Hey Ram'

# Actor embeddings: List of paths to actor face embedding pickle files
ACTOR_EMBEDDINGS = [
    '/data0/teja_works/dataset_captioning/actors_embeddings/srk_face_2.pkl'
]
