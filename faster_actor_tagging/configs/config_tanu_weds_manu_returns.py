"""
Configuration File for Actor Face Detection Pipeline - Tanu Weds Manu Returns (2015)
=====================================================
...
MOVIE_FRAMES_DIR = '/data0/PArun/Quality_checklist/dataset/cropped_detected_shots/Sep/Tanu Weds Manu Return'  # UPDATE THIS PATH

# Output: Base directory for all outputs
OUTPUT_DIR = 'output_data/Tanu Weds Manu Return'
