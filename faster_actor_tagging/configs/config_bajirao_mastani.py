"""
Configuration File for Actor Face Detection Pipeline - Bajirao Mastani (2015)
=====================================================
...
MOVIE_FRAMES_DIR = '/data0/PArun/Quality_checklist/dataset/cropped_detected_shots/Sep/Bajirao Mastani'  # UPDATE THIS PATH

# Output: Base directory for all outputs
OUTPUT_DIR = 'output_data/Bajirao Mastani'
