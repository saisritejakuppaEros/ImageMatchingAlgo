"""
Configuration File for Actor Face Detection Pipeline - Hum Tumhare Hain Sanam (2002)
=====================================================
...
MOVIE_FRAMES_DIR = '/data0/PArun/Quality_checklist/dataset/cropped_detected_shots/Sep/HUM TUMHARE HAI SANAM'  # UPDATE THIS PATH

# Output: Base directory for all outputs
OUTPUT_DIR = 'output_data/Hum Tumhare Hain Sanam'
