"""
Configuration File for Actor Face Detection Pipeline - Ra One (2011)
=====================================================
...
MOVIE_FRAMES_DIR = '/data0/PArun/Quality_checklist/dataset/cropped_detected_shots/Sep/Ra One'  # UPDATE THIS PATH

# Output: Base directory for all outputs
OUTPUT_DIR = 'output_data/Ra One'
